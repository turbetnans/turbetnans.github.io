class Camera extends GameChildProcess {
	...
	public var cWid(get,never) : Int;  inline function get_cWid() return M.ceil(pxWid/Const.GRID_X);
	public var cHei(get,never) : Int;  inline function get_cHei() return M.ceil(pxHei/Const.GRID_Y);
	...
	public var cLeft(get,never) : Int;  inline function get_cLeft() return Std.int( pxLeft/Const.GRID_X );
	public var cRight(get,never) : Int;  inline function get_cRight() return M.ceil( pxRight/Const.GRID_X );
	public var cTop(get,never) : Int;  inline function get_cTop() return Std.int( pxTop/Const.GRID_Y );
	public var cBottom(get,never) : Int;  inline function get_cBottom() return M.ceil( pxBottom/Const.GRID_Y );
	...
	**/
	public inline function isOnScreenCase(cx:Int, cy:Int, padding=32) {
		return cx*Const.GRID_X>=pxLeft-padding && (cx+1)*Const.GRID_X<=pxRight+padding
			&& cy*Const.GRID_Y>=pxTop-padding && (cy+1)*Const.GRID_Y<=pxBottom+padding;
	}
